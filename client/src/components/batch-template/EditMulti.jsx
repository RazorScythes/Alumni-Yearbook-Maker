                    ...
                    <div className="flexbox-2">
                        {
                            templateList !== undefined &&
                                ...
                                />
                                <CardPicker 
                                    alt={props.data.template_id.template2 !== null ? props.data.template_id.template2.image : ''}
                                    width="16rem"
                                    height={245}
                                    title="Commence"
                                    data={templateList}
                                ...
                                />
                                <CardPicker 
                                    alt={props.data.template_id.template3 !== null ? props.data.template_id.template3.image : ''}
                                    width="16rem"
                                    height={245}
                                    title="Events"
                                    data={templateList}
                                ...
                                />
                                <CardPicker 
                                    alt={props.data.template_id.template4 !== null ? props.data.template_id.template4.image : ''}
                                    width="16rem"
                                    height={245}
                                    title="Institutes"
                                    data={templateList}
                    ...
                    <div className="flexbox-2">
                        ...
                        }
                        {
                            nametagsList !== undefined && nametagsList.length > 0 ?
                                <CardPicker 
                                    alt={props.data.nametags_id !== null ? props.data.nametags_id.image : ''}
                                    width="20rem"
                                    height={155}
                                    title="Nametag"
                                    data={nametagsList}
